...
/*
  ...
  Uses "flex flex-col" so the content stretches and the tech tags
  + link are pushed to the bottom via "mt-auto". This keeps cards
  visually aligned in a grid even when descriptions vary in length.

  The hover effect (hover:shadow-lg hover:border-primary/50) gives
  tactile feedback that the card is interactive.
*/
